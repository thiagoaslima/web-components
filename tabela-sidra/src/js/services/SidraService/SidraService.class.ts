...
import { ApiSidra } from './SidraService.interface';
...
export class SidraService {
    ...
    getValues(params: ApiSidra.Parameters): Promise<ApiSidra.Response[]> {
        ...
        return this._requestService.getJSON(this._buildUrl(params)).then((response: JSON) => response[0]);
    }
